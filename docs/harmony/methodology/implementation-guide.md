...
- **Commands & hooks**: `speckit init …` to author; `speckit validate …` to ensure structure; `speckit render …` to publish. See `docs/harmony/ai-toolkit/README.md` (SpecKit + PlanKit sections) and docs/harmony/ai-toolkit/planning-and-orchestration/speckit/guide.md for wrapper details and contracts.
...
See `docs/harmony/ai-toolkit/README.md` (SpecKit + PlanKit sections) for wrapper details.
