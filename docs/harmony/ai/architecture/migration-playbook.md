...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [overview](./overview.md), [monorepo layout](./monorepo-layout.md), [repository blueprint](./repository-blueprint.md), [governance model](./governance-model.md), [runtime policy](./runtime-policy.md), [observability requirements](./observability-requirements.md), [tooling integration](./tooling-integration.md), [kaizen subsystem](./kaizen-subsystem.md), [knowledge plane](./knowledge-plane.md), [contracts registry](./contracts-registry.md), [python runtime workspace](./python-runtime-workspace.md)
