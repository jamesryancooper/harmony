...
Related docs: [monorepo polyglot (normative)](./monorepo-polyglot.md), [runtime architecture](./runtime-architecture.md), [runtime policy](./runtime-policy.md), [knowledge plane](./knowledge-plane.md), [tooling integration](./tooling-integration.md), [python runtime workspace](./python-runtime-workspace.md)
