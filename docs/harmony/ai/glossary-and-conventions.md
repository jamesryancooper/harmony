...
- Slice: A vertical feature module with ports/adapters boundaries. See `docs/harmony/architecture/slices-vs-layers.md`.
- Layer: Cross‑cutting governance/control plane concerns (quality gates, observability, kaizen). Not a runtime call layer.
- Thin Control Plane: Flags, policy gates, contracts, observability guardrails. See `docs/harmony/architecture/overview.md`.
- Knowledge Plane (KP): Unified, queryable engineering knowledge. See `docs/harmony/architecture/knowledge-plane.md`.
- Kaizen/Improve Layer: Autonomous hygiene PRs with HITL. See `docs/harmony/methodology/improve-layer.md`.
...
- PRs: Small, reviewable; include risk level and rollback/flag notes. See `docs/harmony/architecture/governance-model.md` for required PR fields.
