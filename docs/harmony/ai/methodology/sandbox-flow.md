...
- Make it easy for a small team to:
...
- **Sandbox angle**:
  ...
  - Record these as acceptance criteria to be enforced later by CI and reviewers.
...
- **Postmortems**:
  - For material incidents, teams run blameless postmortems and record follow‑ups.
- **Kaizen / Autopilot**:
