...
| Element | Content |
|---------|---------|
| **Developer Receives** | Continuity — context survives time and team changes |
| **Harmony Provides** | Institutional Memory — ADRs, traces, decision logs, audit trails |
| **Phase** | LEARN |
...
When this pillar fails, knowledge exists only in people's heads. New team members struggle to ramp up, teams revisit decisions that were already made, and answers to "why did we do this?" require finding the one person who remembers.
...
- **"Ask Bob" answers** — Knowledge concentrated in individuals
...
Validated specs from Direction become institutional memory in Continuity. ADRs reference the specs that motivated decisions; specs explain the "why we built this" that survives team changes. Direction creates context; Continuity preserves it.
...
Continuity enables Velocity by reducing ramp-up time. New team members ship faster when decisions are documented, not tribal. Knowledge that persists means less time asking "who knows about X?" and more time building. Continuity's failure mode (slow onboarding) directly undermines Velocity.
...
- "Ask Bob" patterns in support channels
- Repeated decisions on already-decided topics
- Onboarding taking >14 days to first PR
...
| **Onboarding time-to-productivity** | Days from start to first merged PR | ≤14 days | Track start date → first PR |
...
| **Fosters Connection** | ✅ Shared memory fosters team connection |
