...
**Bottleneck-driven slowdowns: waiting for humans, large batches**
...
- **Manual gates everywhere** — Requiring human approval for routine operations
- **Waiting for humans** — Processes that block on unavailable people
...
| **Structures & Scale** | Agentic automation enables scale-in: small teams deliver high frequency without headcount bloat | ◐ Secondary |
...
Focus enables Velocity: absorbed complexity removes infrastructure bottlenecks. Teams can ship fast because they're not rebuilding plumbing every sprint. Velocity is Focus paying dividends.
...
- Long PR queue times (>4 working hours for first response)
