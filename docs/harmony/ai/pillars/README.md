...
| 5 | [Continuity through Institutional Memory](./continuity.md) | LEARN | Context survives time and team changes | ADRs, traces, decision logs, audit trails |
...
| **Direction → Continuity** | Validated specs become institutional memory—the "why we built this" that survives team changes. |
...
| Continuity | ✅ Preserved context helps understanding | ✅ Memory reduces reconstruction effort | ✅ Shared memory fosters team connection | ✅ Data minimalism through focused capture |
| Insight | ✅ Learning makes tools genuinely better | ✅ Eval can include attention metrics | ✅ Retrospectives foster team connection | ✅ Learning optimizes for flourishing |
