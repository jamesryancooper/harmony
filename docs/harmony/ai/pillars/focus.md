...
description: Build features, not infrastructure — Harmony handles the rest.
phase: PLAN
---

# Focus through Absorbed Complexity

> Build features, not infrastructure — Harmony handles the rest.
...
| **Harmony Provides** | Absorbed Complexity — kits, schemas, modular boundaries |
| **Phase** | PLAN |
...
Focus enables Velocity: absorbed complexity removes the infrastructure bottlenecks that slow delivery. Teams can ship fast because they're not rebuilding the same plumbing every sprint.
...
- [Architecture Overview](../architecture/overview.md) — Hexagonal boundaries
