...
For a complete picture of how PlanKit, FlowKit, AgentKit, and the shared LangGraph runtime fit together, see `docs/harmony/ai-toolkit/planning-and-orchestration/kit-roles.md`.
