...
For a full conceptual overview of how PlanKit, AgentKit, FlowKit, and the shared runtime fit together, see `docs/harmony/ai-toolkit/planning-and-orchestration/kit-roles.md`.
...
1. Follow the FlowKit instructions in `docs/harmony/ai-toolkit/planning-and-orchestration/flowkit/guide.md#44-visualizing-runs-in-langgraph-studio` to install the CLI and run `langgraph dev --config langgraph.json`.
