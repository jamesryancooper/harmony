...
Related docs: [agent roles](./agent-roles.md), [kaizen subsystem](./kaizen-subsystem.md), [knowledge plane](./knowledge-plane.md)
...
This is developer-facing documentation for engineers building, operating, and extending Harmony’s autonomic loop. It covers responsibilities, data flows, checkpoints, and operational triggers. It does not prescribe CI/CD tooling specifics beyond required outcomes.

## System Context

- **Managed Element**: the production system and monorepo that changes over time.
- **Managing Element**: AI agents and humans who observe, decide, and act on the system.
- **Knowledge Plane (K)**: shared knowledge base storing architecture, specs, metrics, findings, plans, results, and policy context used across all phases.
- **Thin Control Plane**: repo-local flags, policy gates, contracts, and observability guardrails that constrain agent behavior and provide deterministic outcomes without introducing runtime complexity.
