...
- Thin Control Plane: provides the shared guardrails (flags, policy checks, contract tests, observability baselines) that all agents must respect; violations fail‑closed and are surfaced for HITL decisions.
