...
This document codifies Harmony’s four pillars and how they translate into day‑to‑day decisions. For deeper operational mapping and examples across the lifecycle, see `docs/harmony/methodology/README.md`.

## Purpose

- Provide a compact, quotable set of principles that guide design and delivery.
- Connect day‑to‑day decisions to the four pillars and governance model.
...
- When a principle conflicts, favor the four pillars and governance safety.
