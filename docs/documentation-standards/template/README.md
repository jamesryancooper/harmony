...
For full guidance on how these stubs fit together and how to use them, see the Documentation Standards guide: [docs/documentation-standards/README.md](../README.md).
...
- For methodology alignment, see `docs/methodology/README.md`.
