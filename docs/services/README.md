...
- Methodology: services = concrete tools used to implement the Spec → Plan → Flow → Run lifecycle; see also `docs/services/planning/service-roles.md` for canonical roles.
