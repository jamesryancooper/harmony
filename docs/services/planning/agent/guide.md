...
For a full conceptual overview of how Plan, Agent, Flow, and the shared runtime fit together, see `docs/services/planning/service-roles.md`.
...
1. Follow the Flow instructions in `docs/services/planning/flow/guide.md#44-visualizing-runs-in-langgraph-studio` to install the CLI and run `langgraph dev --config langgraph.json`.
