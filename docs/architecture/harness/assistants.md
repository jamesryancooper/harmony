...
Assistants are **stateless subagents**—they inherit context from the calling agent or harness, complete their focused task, and return results. They assist agents by handling specialized work that benefits from domain focus.
...
│                    ▼                                            │
│  SKILLS (Capabilities)                                          │
│  refactor, synthesize, create-harness                         │
...
**Rule C — Locality:**
Nearest `.harmony/agency/assistants/registry.yml` wins. Child harnesses can override parent assistants.
