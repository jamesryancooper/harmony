...
**Use a workflow when:** The task requires multiple distinct phases that benefit from separate files, explicit state passing between steps, or coordination across agents (e.g., "scaffold a workspace," "partition and distribute an audit across agents").
...
- [Agent Skills Specification](../skills/specification.md) -- Skills format specification
- [Skills Architecture](../skills/architecture.md) -- Skills implementation architecture
- [Workflow Template](../../../../.harmony/orchestration/workflows/_template/) -- Canonical workflow template
