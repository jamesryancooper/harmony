...
See also `docs/kits/planning-and-orchestration/kit-roles.md` for how PlanKit, AgentKit, FlowKit, and the LangGraph runtime map onto these physical locations.
