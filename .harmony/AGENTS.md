...
- **Objective brief:** `.harmony/OBJECTIVE.md`
...
1. `/.harmony/AGENTS.md` (canonical), `AGENTS.md` (root ingress), and `CLAUDE.md` (root ingress): repository-wide routing, safety, and operational conventions.
...
Precedence for conflicts: `AGENTS.md` (root ingress for `/.harmony/AGENTS.md`) -> `CONSTITUTION.md` -> `DELEGATION.md` -> `MEMORY.md` -> `AGENT.md` -> `SOUL.md`.
