...
description: Phased plan to finalize the .harmony/agency specification and architecture and integrate it across the harness.
---
...
Deliver a finalized agency subsystem for `.harmony/agency` that:
