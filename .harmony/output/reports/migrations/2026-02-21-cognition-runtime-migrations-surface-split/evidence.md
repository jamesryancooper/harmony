...
- Dated migration records under:
  - `/.harmony/cognition/practices/methodology/migrations/<YYYY-MM-DD>-<slug>/`
...
- Runtime migration records under:
  - `/.harmony/cognition/runtime/migrations/<YYYY-MM-DD>-<slug>/`
- Runtime migration discovery index:
  - `/.harmony/cognition/runtime/migrations/index.yml`
- Migration evidence reports under:
  - `/.harmony/output/reports/migrations/<YYYY-MM-DD>-<slug>/evidence.md`
...
```bash
find .harmony/cognition/practices/methodology/migrations \
...
```bash
rg -n "cognition/practices/methodology/migrations/20|output/reports/[0-9]{4}-[0-9]{2}-[0-9]{2}.*evidence\.md" .harmony \
  --glob '!.harmony/output/**' \
  --glob '!.harmony/cognition/practices/methodology/migrations/legacy-banlist.md' || true
```
...
- Runtime plan:
  - `/.harmony/cognition/runtime/migrations/2026-02-21-cognition-runtime-migrations-surface-split/plan.md`
- ADR:
  - `/.harmony/cognition/runtime/decisions/031-cognition-runtime-migrations-surface-split.md`
- Runtime migration index:
  - `/.harmony/cognition/runtime/migrations/index.yml`
- Decision context addendum:
  - `/.harmony/cognition/runtime/context/decisions.md`
- Evidence report:
  - `/.harmony/output/reports/migrations/2026-02-21-cognition-runtime-migrations-surface-split/evidence.md`
