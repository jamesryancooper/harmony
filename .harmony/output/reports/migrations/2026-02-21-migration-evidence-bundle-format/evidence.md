...
```bash
find .harmony/output/reports/migrations -mindepth 1 -maxdepth 1 -type f | \
...
```bash
find .harmony/output/reports -mindepth 1 -maxdepth 1 -type f | \
...
```bash
for d in .harmony/output/reports/migrations/20*-*; do
  test -d "$d" || continue
...
- Runtime plan:
  - `/.harmony/cognition/runtime/migrations/2026-02-21-migration-evidence-bundle-format/plan.md`
- ADR:
  - `/.harmony/cognition/runtime/decisions/032-migration-evidence-bundle-format.md`
...
- Evidence bundle:
  - `/.harmony/output/reports/migrations/2026-02-21-migration-evidence-bundle-format/`
