...
- **Historical output/report files** (`.harmony/output/`): Leave as-is. These are frozen audit artifacts and updating them would misrepresent what was reported.
- **Archive files** (`.harmony/capabilities/skills/archive/`): Leave as-is. Historical snapshots.
...
- `.harmony/orchestration/workflows/quality-gate/orchestrate-audit/06-report.md` (lines 88, 116)
- `.harmony/orchestration/workflows/meta/create-skill(x)/03-initialize-skill.md` (lines 31, 41)
- `.harmony/cognition/analyses/workflows-vs-skills-analysis.md` (lines 22-23, 71, 183, 479, 774)
- `.harmony/cognition/context/primitives.md` (line 179)
...
1. Run `.harmony/capabilities/skills/scripts/validate-skills.sh` — all skills should pass
