...
**File:** `.harmony/capabilities/skills/meta/build-mcp-server/SKILL.md`
...
**File:** `.harmony/capabilities/skills/foundations/python-api/SKILL.md` (line 43-50 area)

Change child skill table commands from `/scaffold-package` to `/python-scaffold-package`, etc.

**File:** `.harmony/capabilities/skills/foundations/swift-macos-app/SKILL.md` (line 46-55 area)
...
- `.harmony/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness.md`
- `.harmony/capabilities/skills/logs/audit-migration/2026-02-08-workspace-to-harness-rerun.md`
...
```bash
mv .harmony/capabilities/skills/runs/research-synthesizer .harmony/capabilities/skills/runs/synthesize-research
mv .harmony/capabilities/skills/configs/research-synthesizer .harmony/capabilities/skills/configs/synthesize-research
```
...
```
│  4. REGISTRY (.harmony/capabilities/skills/registry.yml)                     │
...
The current diagram shows two separate blocks both pointing to `.harmony/capabilities/skills/` as if they were distinct directories ("Shared skill definitions" and "Harness-specific configuration"). Merge into a single accurate tree:
...
**File:** `.harmony/capabilities/skills/README.md` (add new section)
...
**File:** `.harmony/capabilities/skills/capabilities.yml` (add comment block)
...
```bash
bash .harmony/capabilities/skills/scripts/validate-skills.sh
```
