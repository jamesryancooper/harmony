# Plan: `tools/` and `services/` Subsystems for `.harmony/capabilities/`

## Context

The `.harmony/` harness is tech-stack-agnostic (markdown + YAML), but the current
`packages/kits/` implementation ties domain capabilities to TypeScript. This plan
introduces two new subsystems under `.harmony/capabilities/` to make these
...
**Files to create:**
- `.harmony/capabilities/services/conventions/error-codes.md`
- `.harmony/capabilities/services/conventions/run-records.md`
- `.harmony/capabilities/services/conventions/observability.md`
- `.harmony/capabilities/services/conventions/idempotency.md`
...
### Files to create
- `.harmony/capabilities/tools/README.md`
...
**`.harmony/capabilities/README.md`** — Expand from 3-subsystem to 4-subsystem
table. Add the 2x2 classification diagram. Update interaction model descriptions.

**`.harmony/catalog.md`** — Add `## Tools` section (pack table, usage example)
...
**`.harmony/START.md`** — Update the structure tree to show `tools/` and
