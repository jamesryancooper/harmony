...
Through a design conversation, we established that the Harmony harness
(`.harmony/`) should adopt the **agent-as-runtime model**: the harness ships as
...
All in `.harmony/capabilities/services/conventions/`. Follow existing convention
...
**8. `.harmony/capabilities/services/capabilities.yml`**
...
**10. `.harmony/capabilities/services/README.md`**
...
- [x] `.harmony/capabilities/services/conventions/rich-contracts.md`
- [x] `.harmony/capabilities/services/conventions/declarative-rules.md`
- [x] `.harmony/capabilities/services/conventions/fixtures.md`
- [x] `.harmony/capabilities/services/conventions/validation-tiers.md`
- [x] `.harmony/capabilities/services/conventions/implementation-generation.md`
