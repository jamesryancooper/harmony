...
| 10 | `ideation:maintainability` | `capabilities:operability` | `speed_of_development` | `ease_of_use` |

## Matrix

| Attribute | `agency` | `capabilities` | `cognition` | `continuity` | `ideation` | `orchestration` | `output` | `quality` | `runtime` | `scaffolding` |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
| `Autonomy` (`autonomy`) | 5 | 4 | 4 | 4 | 1 | 5 | 4 | 4 | 4 | 4 |
...
| `Deployability` (`deployability`) | 4 | 4 | 4 | 4 | 4 | 4 | 4 | 4 | 4 | 4 |
