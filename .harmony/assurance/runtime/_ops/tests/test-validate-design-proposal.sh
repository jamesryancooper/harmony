...
VALIDATE_SCRIPT=".harmony/assurance/runtime/_ops/scripts/validate-design-proposal.sh"
...
create_fixture_repo() {
  ...
  cp "$REPO_ROOT/.harmony/assurance/runtime/_ops/scripts/validate-design-proposal.sh" \
    "$fixture_root/.harmony/assurance/runtime/_ops/scripts/validate-design-proposal.sh"
  printf '%s\n' "$fixture_root"
}
