...
new_fixture_proposal() {
  ...
  proposal_root="$fixture_root/.proposals/architecture/fixture-proposal"
...
active:
  - id: "fixture-proposal"
    ...
    path: ".proposals/architecture/fixture-proposal"
    title: "Fixture Architecture Proposal"
    status: "draft"
    promotion_targets:
      - ".harmony/example.md"
...
case_audit_passes() {
  ...
  fixture_rel=".proposals/architecture/fixture-proposal"
