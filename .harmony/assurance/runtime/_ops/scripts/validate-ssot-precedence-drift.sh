...
check_matrix_contract() {
  ...
  require_text \
    "$SPEC_FILE" \
    "| runtime-execution | \`/.harmony/engine/runtime/**\` |" \
  ...
  require_text \
    "$SPEC_FILE" \
    "| governance-policy | \`/.harmony/*/governance/**\` |" \
  ...
  require_text \
    "$SPEC_FILE" \
    "| operating-practices | \`/.harmony/*/practices/**\` |" \
...
check_for_conflicting_wording() {
  ...
  while IFS= read -r line; do
    ...
    case "$rel" in
      ...
      .harmony/assurance/governance/precedence.md|\
