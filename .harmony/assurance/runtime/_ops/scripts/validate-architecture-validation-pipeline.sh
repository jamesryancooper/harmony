...
check_stage_contracts() {
  ...
  require_fixed "validate-design-package-standard.sh" "$WORKFLOW_DIR/stages/09-verify.md" "verify stage runs the standard validator for manifest-bearing packages"
