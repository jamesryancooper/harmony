...
SOURCE_DIR="$HARMONY_DIR/scaffolding/runtime/bootstrap"
MANIFEST_FILE="$SOURCE_DIR/manifest.yml"
LIVE_WRAPPER="$HARMONY_DIR/scaffolding/runtime/_ops/scripts/init-project.sh"
TEMPLATE_WRAPPER="$HARMONY_DIR/scaffolding/runtime/templates/harmony/scaffolding/runtime/_ops/scripts/init-project.sh"
