...
Projects are **human-led explorations** that live in `.harmony/ideation/projects/`. They provide isolated scope, memory, and continuity for structured research spanning multiple sessions — and produce artifacts that feed the main harness.
