# FlowKit ↔ Harmony Integration — Exploration & Recommendation
...
|----------|:-----:|---------------|
| Architecture fit | 5 | Cursor→Workspace→Package→Runtime matches Harmony layering |
...
**Trade-off:** Fundamentally violates Harmony's placement rules. Not recommended.
...
1. **Respects Harmony's architectural boundaries:**
