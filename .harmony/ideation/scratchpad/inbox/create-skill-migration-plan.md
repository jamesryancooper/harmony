...
```
.harmony/workflows/skills/create-skill/
...
- `.harmony/skills/manifest.yml` — Add skill entry with triggers
- `.harmony/skills/registry.yml` — Add extended metadata
...
**Idempotency:** If `.harmony/skills/<skill-name>/SKILL.md` exists, skip to Phase 3.
```
...
|--------|----------|-------------|
| Skill directory | `.harmony/skills/<skill-name>/` | New skill with SKILL.md and references/ |
| Manifest entry | `.harmony/skills/manifest.yml` | Discovery entry with triggers |
| Registry entry | `.harmony/skills/registry.yml` | Extended metadata |
...
```bash
mkdir -p .harmony/skills/create-skill/references
```

Files to create:
- `.harmony/skills/create-skill/SKILL.md`
- `.harmony/skills/create-skill/references/behaviors.md`
- `.harmony/skills/create-skill/references/io-contract.md`
- `.harmony/skills/create-skill/references/safety.md`
- `.harmony/skills/create-skill/references/validation.md`
- `.harmony/skills/create-skill/references/examples.md`
...
- `Write`: Limited to `.harmony/skills/**`, `.workspace/catalog.md`
- `Edit`: Limited to `.harmony/skills/manifest.yml`, `.harmony/skills/registry.yml`
- `Bash(mkdir)`: Limited to `.harmony/skills/`
...
Mark `.harmony/workflows/skills/create-skill/` for removal:
