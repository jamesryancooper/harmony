...
- Waiver/exception taxonomy: [Waivers and Exceptions](./_meta/docs/waivers-and-exceptions.md).
...
`material_side_effect` (see [RA/ACP Glossary](./_meta/docs/ra-acp-glossary.md)).
...
[RA/ACP Promotion Inputs Matrix](./_meta/docs/ra-acp-promotion-inputs-matrix.md#telemetry-profile-gate-canonical)
