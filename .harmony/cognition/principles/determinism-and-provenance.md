...
Terminology for apply/promote/finalize (including `contraction` alias) and approval/attestation/quorum is defined in [RA/ACP Glossary](./_meta/docs/ra-acp-glossary.md).
