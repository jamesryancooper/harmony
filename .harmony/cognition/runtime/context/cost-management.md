...
This guide explains how AI costs are managed in Harmony. **You don't need to do much** — the system handles cost optimization automatically. This page tells you what you need to know.
...
harmony cost estimate "Add user authentication"
...
Stored locally in `.harmony/cost-data.json`. Costs are not sent anywhere external.
