...
- Supersedes: `/.harmony/cognition/_meta/architecture/content-plane/` naming and path authority

## Context

Harmony no longer treats publishing/content concerns as foundational planes.
...
- Directory rename:
  - `/.harmony/cognition/_meta/architecture/content-plane/`
  - ->
...
- Terminology canonicalization across active architecture docs:
  ...
  - `HCP` -> `HAS`
  - `Harmony Content Graph` -> `Harmony Artifact Graph`
