...
- Supersedes: Implicit/overlapping policy ownership language between
  `/.harmony/engine/` and `/.harmony/capabilities/`
- Related:
  - `/.harmony/engine/governance/runtime-capability-authority-boundary.md`
  - `/.harmony/engine/governance/README.md`
  - `/.harmony/capabilities/governance/README.md`

## Context

Harmony already defined bounded surfaces for `engine/` and `capabilities/`,
