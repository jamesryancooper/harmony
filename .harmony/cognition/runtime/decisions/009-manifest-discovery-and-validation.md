...
3. **Undocumented principles** - Harmony's design principles were implicit rather than documented

Additionally, the system had Harmony-specific extensions beyond the agentskills.io spec that needed documentation:
