...
- Scope: `/.harmony/capabilities/**` plus active references in harness docs, scripts, workflows, templates, and CI workflows.
...
- Legacy root runtime paths:
  ...
  - `/.harmony/capabilities/tools/`
  - `/.harmony/capabilities/services/`
- Legacy root governance path:
  - `/.harmony/capabilities/_ops/policy/`
- Legacy runtime conventions path:
  - `/.harmony/capabilities/services/conventions/`
...
- Runtime capability authority:
  ...
  - `/.harmony/capabilities/runtime/tools/`
  - `/.harmony/capabilities/runtime/services/`
- Governance authority:
  - `/.harmony/capabilities/governance/policy/`
- Practices authority:
  - `/.harmony/capabilities/practices/services-conventions/`
...
- New components or files:
  ...
  - `/.harmony/capabilities/governance/README.md`
  - `/.harmony/capabilities/practices/README.md`
  - `/.harmony/capabilities/practices/services-conventions/README.md`
  - `/.harmony/cognition/runtime/decisions/023-capabilities-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
  - `/.harmony/capabilities/runtime/commands/manifest.yml`
  - `/.harmony/capabilities/runtime/skills/manifest.yml`
  - `/.harmony/capabilities/runtime/tools/manifest.yml`
...
- `/.harmony/output/reports/migrations/2026-02-20-capabilities-bounded-surfaces/evidence.md`
- `/.harmony/cognition/runtime/decisions/023-capabilities-bounded-surfaces-clean-break-migration.md`
