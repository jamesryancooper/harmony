...
- Skill group definition key `quality-gate` in `/.harmony/capabilities/runtime/skills/capabilities.yml`
- Workflow manifest entries with `group: quality-gate`
- Workflow group definition key `quality-gate` in `/.harmony/orchestration/runtime/workflows/manifest.yml`
...
- Remove legacy schema or manifest keys:
  - remove `quality-gate` group definitions from:
    - `/.harmony/capabilities/runtime/skills/capabilities.yml`
...
- Add or adjust new schema or manifest keys:
  ...
  - update all `group` and `path` values in:
    ...
    - `/.harmony/orchestration/runtime/workflows/manifest.yml`
    - `/.harmony/orchestration/runtime/workflows/registry.yml` (path-linked references)
...
- Update references in:
  ...
  - `/.harmony/capabilities/_meta/architecture/*` where examples use `quality-gate`
...
- New components or files:
  ...
  - Migration plan folder:
    - `/.harmony/cognition/runtime/migrations/2026-02-21-quality-gate-domain-split/`
  - Decision record:
...
- `/.harmony/output/reports/migrations/2026-02-21-quality-gate-domain-split/evidence.md`
- `/.harmony/cognition/runtime/decisions/029-quality-gate-domain-split-clean-break-migration.md`
