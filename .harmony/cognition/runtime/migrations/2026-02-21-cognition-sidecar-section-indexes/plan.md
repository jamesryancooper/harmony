...
- `/.harmony/cognition/practices/methodology/sections/`
...
- Sidecar section indexes colocated with canonical docs:
  - `/.harmony/cognition/practices/methodology/README.index.yml`
  - `/.harmony/cognition/practices/methodology/implementation-guide.index.yml`
  - `/.harmony/cognition/_meta/architecture/README.index.yml`
  - `/.harmony/cognition/_meta/architecture/resources.index.yml`
