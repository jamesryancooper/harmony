...
- New components or files:
  ...
  - `/.harmony/cognition/runtime/decisions/024-assurance-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
...
- `/.harmony/output/reports/migrations/2026-02-20-assurance-bounded-surfaces/evidence.md`
- `/.harmony/cognition/runtime/decisions/024-assurance-bounded-surfaces-clean-break-migration.md`
