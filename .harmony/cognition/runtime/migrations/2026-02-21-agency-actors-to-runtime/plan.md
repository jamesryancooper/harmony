...
description: Clean-break migration plan for replacing `/.harmony/agency/actors/` with `/.harmony/agency/runtime/` as the sole runtime surface.
---
...
- Scope: `/.harmony/agency/**`, active references across docs/templates/validators, and migration governance artifacts.
...
- Delete:
  - `/.harmony/agency/actors/` directory.
- Replace call-sites:
...
- [x] No `/.harmony/agency/actors/` path remains on disk.
...
- `/.harmony/output/reports/migrations/2026-02-21-agency-actors-to-runtime/evidence.md`
- `/.harmony/cognition/runtime/decisions/028-agency-runtime-surface-clean-break-rename.md`
