...
- Scope: `/.harmony/scaffolding/**` plus active references in harness docs, workflows, commands, skills, templates, and validators.

## 2) What Is Being Removed (Explicit)

- Legacy scaffolding root runtime paths:
  - `/.harmony/scaffolding/templates/`
  - `/.harmony/scaffolding/_ops/scripts/`
...
- New components or files:
  - `/.harmony/scaffolding/runtime/README.md`
  - `/.harmony/scaffolding/governance/README.md`
  - `/.harmony/scaffolding/practices/README.md`
  - `/.harmony/cognition/runtime/decisions/025-scaffolding-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
  - `/.harmony/scaffolding/runtime/_ops/scripts/init-project.sh`
  - `/.harmony/scaffolding/runtime/templates/harmony/manifest.json`
  - `/.harmony/scaffolding/governance/patterns/README.md`
...
- `/.harmony/output/reports/migrations/2026-02-20-scaffolding-bounded-surfaces/evidence.md`
- `/.harmony/cognition/runtime/decisions/025-scaffolding-bounded-surfaces-clean-break-migration.md`
