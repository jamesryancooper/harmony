...
- New components or files:
  ...
  - `/.harmony/cognition/runtime/decisions/026-engine-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
  - `/.harmony/engine/runtime/run`
  - `/.harmony/engine/runtime/run.cmd`
...
- `/.harmony/output/reports/migrations/2026-02-20-engine-bounded-surfaces/evidence.md`
- `/.harmony/cognition/runtime/decisions/026-engine-bounded-surfaces-clean-break-migration.md`
