...
- New components or files:
  ...
  - `/.harmony/cognition/decisions/025-scaffolding-bounded-surfaces-clean-break-migration.md`
- New entrypoints:
...
- `/.harmony/output/reports/2026-02-20-scaffolding-bounded-surfaces-migration-evidence.md`
- `/.harmony/cognition/decisions/025-scaffolding-bounded-surfaces-clean-break-migration.md`
