...
- workflow command: `/audit-documentation-workflow`
  (`.harmony/orchestration/runtime/workflows/audit/audit-documentation-workflow/WORKFLOW.md`)
...
- CI must run governance lint and docs promotion fail-closed contract tests
  ...
  and
  `.harmony/cognition/_ops/principles/scripts/test-docs-promotion-fail-closed.sh`.
