...
Complexity Calibration is Harmony's governing rule for design and delivery complexity. The target is not minimum novelty or minimum code volume. The target is the smallest robust solution that meets constraints.
