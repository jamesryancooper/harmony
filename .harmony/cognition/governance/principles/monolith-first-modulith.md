...
Harmony defaults to a modular monolith with clear slice boundaries, contracts, and ownership. The goal is to keep deployment and debugging simple while preserving seams for future extraction.
...
- `.harmony/cognition/governance/pillars/focus.md`
- `.harmony/cognition/governance/pillars/velocity.md`
