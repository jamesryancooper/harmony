...
- [Harness Architecture](../../_meta/architecture/README.md) — Progressive disclosure in harness design
- [Skills Specification](../../../capabilities/_meta/architecture/specification.md) — Four-tier skill structure
