...
This crosswalk defines how methodology artifacts under `/.harmony/cognition/practices/methodology/` should resolve authority when guidance appears in multiple governance surfaces.
...
1. `AGENTS.md`
2. `/.harmony/agency/governance/CONSTITUTION.md`
3. `/.harmony/agency/governance/DELEGATION.md`
4. `/.harmony/agency/governance/MEMORY.md`
5. `/.harmony/agency/runtime/agents/architect/AGENT.md`
6. `/.harmony/agency/runtime/agents/architect/SOUL.md`
