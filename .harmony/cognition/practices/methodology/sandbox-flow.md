...
- Architecture:
  ...
  - `.harmony/scaffolding/practices/examples/stack-profiles/nextjs-astro-vercel.md` (non-normative Next.js/Astro/Vercel profile example for previews, flags, and promotion).
...
- **Promotion**:
  - Production is updated via **manual promote** (e.g., `vercel promote <preview-url>`), not auto‑deploy, as described in `.harmony/scaffolding/practices/examples/stack-profiles/nextjs-astro-vercel.md`.
- **Flags and rollout**:
