...
4. Runtime indexes (`/.harmony/cognition/runtime/**/index.yml`) provide centralized discovery across decisions and migrations.
...
|---|---|---|---|
| `/.harmony/cognition/practices/methodology/` | `README.md`, `implementation-guide.md` | `README.index.yml`, `implementation-guide.index.yml` | `index.yml` |
| `/.harmony/cognition/_meta/architecture/` | `README.md`, `resources.md` | `README.index.yml`, `resources.index.yml` | `index.yml` |
...
- Structure validation: `/.harmony/assurance/runtime/_ops/scripts/validate-harness-structure.sh`
- Skill alignment validation: `/.harmony/assurance/runtime/_ops/scripts/validate-audit-subsystem-health-alignment.sh`
