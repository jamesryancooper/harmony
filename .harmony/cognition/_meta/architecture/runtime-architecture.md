...
The Harmony platform exposes a **shared, platform-level runtime service** that executes flows and graphs on behalf of:
...
- **Docs maintainers and architects** evolving Harmony’s runtime model.
