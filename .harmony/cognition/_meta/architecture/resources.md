...
**Harmony Polyglot Monorepo Blueprint** (Internal Doc) — Harmony, 2025
...
- Related docs: [overview](./overview.md), [repository blueprint](./repository-blueprint.md), [monorepo layout](./monorepo-layout.md), [contracts registry](./contracts-registry.md), [python runtime workspace example](/.harmony/scaffolding/practices/examples/stack-profiles/python-runtime-workspace.md)
...
- Level: Intermediate
- Last reviewed: 2025-11-12
- Related docs: [implementation profile example](/.harmony/scaffolding/practices/examples/stack-profiles/nextjs-astro-vercel.md)
