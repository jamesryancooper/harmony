...
- Accessibility baseline
  ...
  - Optional: use `.harmony/cognition/_meta/architecture/a11ykit.md` to centralize CI accessibility checks and surface results as policy/evaluation gates with Knowledge Plane provenance.
- Feature flags
...
- Monorepo Layout: `.harmony/cognition/_meta/architecture/monorepo-layout.md`
...
- Kaizen Subsystem: `.harmony/cognition/_meta/architecture/kaizen-subsystem.md`
