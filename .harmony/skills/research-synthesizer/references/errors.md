...
Error conditions, recovery procedures, and troubleshooting for the research-synthesizer skill.
...
- [ ] Ran validation: `./scripts/validate-skills.sh research-synthesizer`
