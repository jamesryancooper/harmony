...
Complete worked examples demonstrating the research-synthesizer skill.
...
**Path:** `outputs/drafts/auth-patterns-synthesis.md`
...
**Path:** `outputs/drafts/api-design-synthesis.md`

```markdown
# Research Synthesis: api-design

**Generated:** 2025-01-14T14:22:00Z
**Source:** sources/api-design/
...
```bash
/synthesize-research sources/quick-notes/
```
...
**Path:** `outputs/drafts/quick-notes-synthesis.md`

```markdown
# Research Synthesis: quick-notes

**Generated:** 2025-01-15T09:00:00Z
**Source:** sources/quick-notes/
