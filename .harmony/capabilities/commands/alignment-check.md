...
```bash
bash .harmony/quality/_ops/scripts/alignment-check.sh --profile <aspect[,aspect...]> [--dry-run]
```

List profiles:

```bash
bash .harmony/quality/_ops/scripts/alignment-check.sh --list-profiles
```
...
- **Runner:** `.harmony/quality/_ops/scripts/alignment-check.sh`
- **Commit/PR validator:** `.harmony/quality/_ops/scripts/validate-commit-pr-alignment.sh`
- **Quality baseline:** `.harmony/quality/README.md`
