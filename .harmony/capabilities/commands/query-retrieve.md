...
```bash
bash .harmony/capabilities/services/retrieval/query/impl/query.sh < /tmp/query-retrieve.json
```
...
- **Service:** `.harmony/capabilities/services/retrieval/query/`
- **Input schema:** `.harmony/capabilities/services/retrieval/query/schema/input.schema.json`
- **Output schema:** `.harmony/capabilities/services/retrieval/query/schema/output.schema.json`
