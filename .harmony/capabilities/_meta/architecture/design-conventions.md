...
Skills can write deliverables to custom locations beyond the standard categories. The `.harmony/` directory designates its **parent directory** as the harness root (see [Architecture](./architecture.md#harness-definition)), enabling three tiers of output locations:
...
skills:
  generate-client:
    outputs:
      ...
      # Tier 3: Harness root (parent of .harmony/)
...
- [Architecture](./architecture.md) — Hierarchical harness model
