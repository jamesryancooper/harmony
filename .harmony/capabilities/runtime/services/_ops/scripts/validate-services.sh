...
HARMONY_DIR="$(cd "$SERVICES_DIR/../../.." && pwd)"
MANIFEST="$SERVICES_DIR/manifest.yml"
REGISTRY="$SERVICES_DIR/registry.yml"
CAPABILITIES="$SERVICES_DIR/capabilities.yml"
EXCEPTIONS_FILE="$HARMONY_DIR/capabilities/_ops/state/deny-by-default-exceptions.yml"
AGENT_ONLY_POLICY_FILE="$HARMONY_DIR/capabilities/governance/policy/agent-only-governance.yml"
AGENT_ONLY_VALIDATOR="$HARMONY_DIR/capabilities/_ops/scripts/validate-agent-only-governance.sh"
POLICY_V2_FILE="$HARMONY_DIR/capabilities/governance/policy/deny-by-default.v2.yml"
POLICY_RUNNER="$HARMONY_DIR/engine/runtime/policy"
TODAY="$(date +%F)"
...
main() {
  ...
  if [[ "$VALIDATION_PROFILE" == "strict" ]]; then
    local conventions=(
      "$HARMONY_DIR/capabilities/practices/services-conventions/error-codes.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/run-records.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/observability.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/idempotency.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/rich-contracts.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/declarative-rules.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/fixtures.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/validation-tiers.md"
      "$HARMONY_DIR/capabilities/practices/services-conventions/implementation-generation.md"
    )
