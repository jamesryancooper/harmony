...
- The native **Harmony flow runtime** under `.harmony/capabilities/runtime/services/execution/flow/**`
- Optional external runtime adapters (for example LangGraph HTTP)

Use this guide together with:

- `.harmony/capabilities/runtime/services/planning/README.md`
...
- In the harness runtime (`.harmony/capabilities/runtime/services/execution/flow/**` + runtime clients), it defines:
...
- The native runtime under `.harmony/capabilities/runtime/services/execution/flow/**` provides the default concrete implementation.
...
The native runtime under `.harmony/capabilities/runtime/services/execution/flow/**`:
...
Implement flow execution under `.harmony/capabilities/runtime/services/execution/flow/**` with native contracts and deterministic behavior.
...
- Wrap **BMAD** as a Harmony-native service (`plan`) so that:
  ...
  - Callers rely on stable contracts under `.harmony/capabilities/runtime/services/planning/plan/schema/input.schema.json`.
...
- **Keep** native flow runtime in `.harmony/capabilities/runtime/services/execution/flow/**` as the default core runtime.
- **Add new flows** by:
