...
| Contracts (normative)| `.harmony/capabilities/runtime/services/retrieval/parse/schema/input.schema.json`, `.harmony/capabilities/runtime/services/retrieval/parse/schema/output.schema.json` |
...
```bash
cd .harmony/capabilities/runtime/services/retrieval/parse
...
- Inputs: `.harmony/capabilities/runtime/services/retrieval/parse/schema/input.schema.json`
- Outputs: `.harmony/capabilities/runtime/services/retrieval/parse/schema/output.schema.json`
