...
```bash
bash .harmony/capabilities/runtime/services/retrieval/query/impl/query.sh < /tmp/query-retrieve.json
```
...
- **Service:** `.harmony/capabilities/runtime/services/retrieval/query/`
- **Input schema:** `.harmony/capabilities/runtime/services/retrieval/query/schema/input.schema.json`
- **Output schema:** `.harmony/capabilities/runtime/services/retrieval/query/schema/output.schema.json`
