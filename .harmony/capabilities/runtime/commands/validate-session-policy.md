...
```text
/validate-session-policy --file .harmony/capabilities/runtime/services/interfaces/agent-platform/fixtures/native-session-policy.json
```
...
```bash
bash .harmony/capabilities/runtime/services/interfaces/agent-platform/impl/validate-session-policy.sh \
