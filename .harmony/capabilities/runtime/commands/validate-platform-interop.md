...
```bash
bash .harmony/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh [--mode <mode>]
```
...
- **Validator:** `.harmony/capabilities/runtime/services/_ops/scripts/validate-service-independence.sh`
- **Allowlist:** `.harmony/capabilities/runtime/services/_ops/state/provider-term-allowlist.tsv`
