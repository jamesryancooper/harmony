...
Written to `.harmony/capabilities/runtime/skills/_ops/state/logs/audit-migration/{{run_id}}-{partition}.md`.

### Execution Log

Written to `.harmony/capabilities/runtime/skills/_ops/state/logs/audit-migration/{{run_id}}.md`.
...
Written to `.harmony/capabilities/runtime/skills/_ops/state/logs/audit-migration/index.yml`:
