...
description: >
  ...
  coordination, and evidence capture for Harmony methodology receipts.
license: MIT
...
Apply Vercel-specific delivery operations as an optional adapter layer to provider-agnostic Harmony policy.
