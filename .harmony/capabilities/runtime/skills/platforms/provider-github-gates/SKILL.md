...
description: >
  ...
  evidence-link generation aligned to Harmony methodology.
license: MIT
...
- Workflow gate outputs need mapping to Harmony tier/ACP expectations
...
3. **Mapping** - Map provider checks to Harmony gate policy
