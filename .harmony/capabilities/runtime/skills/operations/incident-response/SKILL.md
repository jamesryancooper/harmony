...
description: >
  ...
  post-incident evidence capture aligned with Harmony runtime policy.
license: MIT
...
Run a bounded, evidence-first incident response workflow aligned to Harmony runtime policy and governance.
