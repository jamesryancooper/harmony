...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  1. SKILL DEFINITION (/.harmony/capabilities/runtime/skills/<skill-id>/)                          │
...
│                                                                             │
│  2. SHARED MANIFEST (/.harmony/capabilities/runtime/skills/manifest.yml)                          │
...
│                                                                             │
│  3. REGISTRY (/.harmony/capabilities/runtime/skills/registry.yml)                                 │
│     □ Add skill entry under `skills:`:                                      │
│       - version: "1.0.0"                                                    │
│       - commands: [/<skill-id>]                                             │
...
```bash
# Copy template
cp -r .harmony/capabilities/runtime/skills/_template .harmony/capabilities/runtime/skills/<skill-id>

# Edit files (use your editor)
# Then validate
.harmony/capabilities/runtime/skills/_ops/scripts/validate-skills.sh <skill-id>

# Use --fix to see scaffolding suggestions for missing entries
.harmony/capabilities/runtime/skills/_ops/scripts/validate-skills.sh <skill-id> --fix
```
...
│                                                                             │
│   ┌─────────────────────────────────────────────────────────────────────┐   │
│   │  TIER 1: SHARED FOUNDATION (/.harmony/capabilities/runtime/skills/)                       │   │
│   │  ─────────────────────────────────────────────────────────────────  │   │
...
│                                    ▼                                        │
│   ┌─────────────────────────────────────────────────────────────────────┐   │
│   │  TIER 2: HARNESS CONFIG (/.harmony/capabilities/runtime/skills/)                        │   │
│   │  ─────────────────────────────────────────────────────────────────  │   │
...
│   │       ▲                ▲                 ▲                          │   │
│   │       └────────────────┴─────────────────┘                          │   │
│   │                   Symlinks to .harmony/capabilities/runtime/skills/                      │   │
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
Skills are exposed to different AI agents (Claude, Cursor, Codex) via symlinks from their respective skills directories to the shared `.harmony/capabilities/runtime/skills/` definitions. This allows multiple agents to share the same canonical skill definitions.
...
This creates symlinks for all skills in `.harmony/capabilities/runtime/skills/` to each agent's skills directory.
...
ln -s ../../.harmony/capabilities/runtime/skills/refine-prompt .claude/skills/refine-prompt
ln -s ../../.harmony/capabilities/runtime/skills/refine-prompt .cursor/skills/refine-prompt
ln -s ../../.harmony/capabilities/runtime/skills/refine-prompt .codex/skills/refine-prompt
```
...
| Permission denied     | Check file permissions on `.harmony/capabilities/runtime/skills/`                     |
...
### Manifest Extensions (`.harmony/capabilities/runtime/skills/manifest.yml`)
...
### Registry Extensions (`.harmony/capabilities/runtime/skills/registry.yml`)
