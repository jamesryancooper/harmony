...
```text
/audit-release-readiness scope=".harmony/capabilities/runtime/services" deployment_artifacts_glob="**/SERVICE.md,**/compatibility.yml"
```
...
```text
/audit-release-readiness scope=".harmony" post_remediation=true severity_threshold="high" convergence_k="3"
```
