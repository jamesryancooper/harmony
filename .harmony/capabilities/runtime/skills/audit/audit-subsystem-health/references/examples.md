...
MEDIUM: Doc drift — .harmony/capabilities/_meta/architecture/architecture.md describes "flat directory layout" but skills use group-based nesting
...
**Wrong:**
```
/audit-subsystem-health subsystem=".harmony/" after a directory restructuring
```
