...
See the companion workflow `audit-orchestration-workflow` at `.harmony/orchestration/runtime/workflows/audit/audit-orchestration-workflow/` for coordinated parallel execution.
