...
decisions:
  - id: target-resolution
    ...
    branches:
      ...
      - condition: "domain_path does not exist but matches valid .harmony domain target"
        label: prospective_mode
        next_phase: "Run readiness critique using profile baseline and comparator evidence"
      - condition: "domain_path cannot be normalized to a valid Harmony domain target"
