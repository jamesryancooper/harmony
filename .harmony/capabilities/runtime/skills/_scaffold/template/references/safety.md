...
| **Tier 1**  | `.harmony/capabilities/runtime/skills/_ops/state/runs/{{skill-id}}/**`  | Execution state (session recovery) |
| **Tier 1**  | `.harmony/capabilities/runtime/skills/_ops/state/logs/**`               | Execution logs       |
