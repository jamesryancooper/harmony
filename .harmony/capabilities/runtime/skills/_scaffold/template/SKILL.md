...
metadata:
  ...
  # Note: version is defined in .harmony/capabilities/runtime/skills/registry.yml, not here
# Capability Model
...
#   See: .harmony/capabilities/runtime/skills/composite-skills.md
#
...
- **Execution Logs:** `.harmony/capabilities/runtime/skills/_ops/state/logs/{{skill-id}}/{{run-id}}.md`
