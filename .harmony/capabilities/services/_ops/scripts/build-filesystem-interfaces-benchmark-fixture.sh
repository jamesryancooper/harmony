...
PROFILE_FILE="$HARMONY_DIR/capabilities/services/interfaces/filesystem-snapshot/fixtures/benchmark-profile.tsv"
...
if [[ -z "$fixture_root" ]]; then
  run_id="$(date +%s)-$$"
  fixture_root=".harmony/output/.tmp/filesystem-interfaces-bench/${profile}-${run_id}"
fi
