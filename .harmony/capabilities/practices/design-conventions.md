...
Skills can write deliverables to custom locations beyond the standard categories. The `.harmony/` directory designates its **parent directory** as the harness root (see [Architecture](../_meta/architecture/architecture.md#harness-definition)), enabling three tiers of output locations:
