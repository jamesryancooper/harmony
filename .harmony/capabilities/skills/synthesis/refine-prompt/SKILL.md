...
capabilities: []
allowed-tools: Read Glob Grep Write(../../scaffolding/prompts/*) Write(_state/logs/*)
---
...
Outputs are written to `.harmony/scaffolding/prompts/` (refined prompt) and `_state/logs/refine-prompt/` (execution log).
