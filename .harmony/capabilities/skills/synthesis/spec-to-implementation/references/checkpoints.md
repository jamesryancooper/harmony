...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/skills/runs/spec-to-implementation/{{run-id}}/"
  retention: session
...
- State is stored in `.harmony/capabilities/skills/runs/spec-to-implementation/{{run-id}}/`.
