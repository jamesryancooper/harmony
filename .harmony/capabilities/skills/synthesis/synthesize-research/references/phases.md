...
behavior:
  phases:
    ...
    - name: "Output"
      steps:
        - "Write synthesis to .harmony/output/drafts/{{topic}}-synthesis.md"
        - "Write run log to _state/logs/synthesize-research/{{timestamp}}-synthesize-research.md"
  goals:
...
2. **Write run log**
   - Path: `_state/logs/synthesize-research/{{timestamp}}-synthesize-research.md`
