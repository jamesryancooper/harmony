...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/skills/_ops/state/runs/audit-ui/{{run-id}}/"
  retention: session
...
- Checkpoints are stored in `.harmony/capabilities/skills/_ops/state/runs/audit-ui/{{run-id}}/`.
