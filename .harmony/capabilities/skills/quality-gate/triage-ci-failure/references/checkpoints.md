...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/"
  retention: session
...
- State is saved in `.harmony/capabilities/skills/_ops/state/runs/triage-ci-failure/{{run-id}}/`.
