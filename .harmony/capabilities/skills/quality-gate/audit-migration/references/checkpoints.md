...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/skills/_state/runs/audit-migration/{{run-id}}/"
  retention: session
...
- Checkpoints are written under `.harmony/capabilities/skills/_state/runs/audit-migration/{{run-id}}/`.
