...
Write scope definition to `_state/runs/refactor/{{id}}/scope.md`:
...
Write audit manifest to `_state/runs/refactor/{{id}}/audit-manifest.md`
...
Write change manifest to `_state/runs/refactor/{{id}}/change-manifest.md`
...
Write execution log to `_state/runs/refactor/{{id}}/execution-log.md`
...
Write verification report to `_state/runs/refactor/{{id}}/verification-report.md`
...
2. **Generate suggested commit message:**
   ...
   Save to `_state/runs/refactor/{{id}}/commit-message.txt`

3. **Update log index** (`_state/logs/refactor/index.yml`)
...
4. **Declare completion:**
   ...
   - Suggested commit: _state/runs/refactor/{{id}}/commit-message.txt
   ```
...
Write summary to `_state/runs/refactor/{{id}}/summary.md`
...
1. Look for `_state/runs/refactor/*{{scope-slug}}*/checkpoint.yml`
