...
checkpoints:
  strategy: phase
  storage: ".harmony/capabilities/skills/runs/resolve-pr-comments/{{run-id}}/"
  retention: session
...
- Checkpoints are stored in `.harmony/capabilities/skills/runs/resolve-pr-comments/{{run-id}}/`.
