...
# See: .harmony/capabilities/_meta/architecture/specification.md#tool-permissions-single-source-of-truth
...
- **Configs:** `.harmony/capabilities/skills/_ops/state/configs/{{skill-id}}/` (per-skill configuration overrides)
- **Resources:** `.harmony/capabilities/skills/_ops/state/resources/{{skill-id}}/` (per-skill input materials)
- **Continuity Artifacts:** `.harmony/capabilities/skills/_ops/state/runs/{{skill-id}}/{{run-id}}/` (for stateful/resumable skills)
- **Execution Logs:** `.harmony/capabilities/skills/_ops/state/logs/{{skill-id}}/{{run-id}}.md`
...
See [Reference Artifacts](/.harmony/capabilities/_meta/architecture/reference-artifacts.md) for the complete capability-to-reference mapping.
