...
#
# See: .harmony/capabilities/_meta/architecture/reference-artifacts.md#domain-file-extraction-heuristics
#
safety:
  tool_policy:
  ...
  file_policy:
    write_scope:                   # Paths where writing is allowed
      ...
      - ".harmony/capabilities/skills/_ops/state/runs/**"      # Execution state (session recovery)
      - ".harmony/capabilities/skills/_ops/state/logs/**"      # Logs (always allowed)
...
| **Tier 1**  | `.harmony/capabilities/skills/_ops/state/runs/{{skill-id}}/**`  | Execution state (session recovery) |
