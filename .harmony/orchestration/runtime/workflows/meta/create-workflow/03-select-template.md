...
3. **Select template:**
   ```text
   All workflows use base template: .harmony/orchestration/runtime/workflows/_scaffold/template/
...
```json
{
  "base_template": ".harmony/orchestration/runtime/workflows/_scaffold/template/",
  "complexity": "standard",
