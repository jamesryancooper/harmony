...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/meta/create-workflow`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/meta/create-workflow/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/meta/create-workflow/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/meta/create-workflow/stages/`
