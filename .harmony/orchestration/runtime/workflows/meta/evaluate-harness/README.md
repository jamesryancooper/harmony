...
Evaluate a .harmony directory for structure, token efficiency, and quality signal completeness.

## Target

This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/meta/evaluate-harness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/meta/evaluate-harness/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/meta/evaluate-harness/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/meta/evaluate-harness/stages/`
