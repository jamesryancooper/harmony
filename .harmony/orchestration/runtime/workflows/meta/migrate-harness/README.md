...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/meta/migrate-harness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/meta/migrate-harness/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/meta/migrate-harness/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/meta/migrate-harness/stages/`
