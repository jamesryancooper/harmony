...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/meta/update-harness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/meta/update-harness/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/meta/update-harness/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/meta/update-harness/stages/`
