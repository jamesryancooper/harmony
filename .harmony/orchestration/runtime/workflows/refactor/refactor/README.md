...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/refactor/refactor`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/refactor/refactor/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/refactor/refactor/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/refactor/refactor/stages/`
