...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/foundations/python-api`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/foundations/python-api/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/foundations/python-api/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/foundations/python-api/stages/`
