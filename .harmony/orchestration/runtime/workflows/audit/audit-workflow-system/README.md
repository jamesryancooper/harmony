...
Audit the Harmony workflow system with bounded static analysis, representative rehearsals, stable finding IDs, coverage accounting, and explicit done-gate evaluation.

## Target

This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/audit/audit-workflow-system`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/audit/audit-workflow-system/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/audit/audit-workflow-system/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/audit/audit-workflow-system/stages/`
