...
```text
/audit-orchestration-workflow manifest="..." strategy="by-directory"
```

Post-remediation convergence check:

```text
/audit-orchestration-workflow manifest="..." post_remediation="true" convergence_k="3" seed_list="11,23,37"
```
