...
```text
/audit-change-risk-workflow subsystem=".harmony/capabilities/runtime/services"
```

With migration manifest and strict post-remediation gate:

```text
/audit-change-risk-workflow subsystem=".harmony/capabilities/runtime/services" manifest=".harmony/output/plans/migration.yml" post_remediation="true" convergence_k="3" seed_list="11,23,37"
```
...
- Consolidated workflow report:
  - `.harmony/output/reports/YYYY-MM-DD-audit-change-risk-workflow.md`
