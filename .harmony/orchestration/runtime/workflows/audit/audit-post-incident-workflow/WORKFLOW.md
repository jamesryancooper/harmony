...
```text
/audit-post-incident-workflow incident_id="INC-2026-02-23-001" subsystem=".harmony/capabilities/runtime/services"
```

With strict post-remediation gate:

```text
/audit-post-incident-workflow incident_id="INC-2026-02-23-001" subsystem=".harmony/capabilities/runtime/services" post_remediation="true" convergence_k="3" seed_list="11,23,37"
```
