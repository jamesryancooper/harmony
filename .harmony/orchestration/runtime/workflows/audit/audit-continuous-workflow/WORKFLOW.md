...
steps:
  - id: configure
    ...
    description: Parse audit-continuous-workflow parameters, cadence metadata, and deterministic controls.
  ...
  - id: report
    file: 12-report.md
    description: Generate consolidated audit-continuous-workflow report and bounded-audit evidence bundle.
  - id: verify
    file: 13-verify.md
...
```text
/audit-continuous-workflow subsystem=".harmony/capabilities/runtime/services"
```

With strict post-remediation gate:

```text
/audit-continuous-workflow subsystem=".harmony/capabilities/runtime/services" cadence="weekly" lookback_days="14" post_remediation="true" convergence_k="3" seed_list="11,23,37"
```
...
- Consolidated workflow report:
  - `.harmony/output/reports/YYYY-MM-DD-audit-continuous-workflow.md`
...
| ------- | ---- | ------- |
| 1.0.0 | 2026-02-23 | Initial bounded layered audit-continuous-workflow workflow |
