...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/audit/audit-release-readiness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/audit/audit-release-readiness/workflow.yml`.
...
- `release_readiness_workflow_report` -> `../../output/reports/{{date}}-audit-release-readiness.md`: Consolidated layered release-readiness workflow report with recommendation
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/audit/audit-release-readiness/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/audit/audit-release-readiness/stages/`
