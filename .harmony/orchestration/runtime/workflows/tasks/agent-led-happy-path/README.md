...
This README summarizes the canonical workflow unit at `.harmony/orchestration/runtime/workflows/tasks/agent-led-happy-path`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.harmony/orchestration/runtime/workflows/tasks/agent-led-happy-path/workflow.yml`.
...
- Canonical contract: `.harmony/orchestration/runtime/workflows/tasks/agent-led-happy-path/workflow.yml`
- Canonical stages: `.harmony/orchestration/runtime/workflows/tasks/agent-led-happy-path/stages/`
