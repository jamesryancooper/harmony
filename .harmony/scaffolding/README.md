...
| Asset | Purpose |
|-------|---------|
| `AGENTS.md` | Canonical `/.harmony/AGENTS.md` source rendered by `/init` |
| `BOOT.md` | Optional recurring startup checklist template |
| `BOOTSTRAP.md` | Optional one-time bootstrap checklist template |
| `objectives/` | Objective packs rendered by `/init` into `/.harmony/OBJECTIVE.md` and the active intent contract |
