...
1. Run `.harmony/scaffolding/runtime/_ops/scripts/init-project.sh` (or `/init`) to generate project-level bootstrap files and the repo objective contract.
...
3. Customize `.harmony/AGENTS.md`, `.harmony/OBJECTIVE.md`, `.harmony/scope.md`, and `.harmony/conventions.md` for repo-specific objectives, boundaries, and standards.
