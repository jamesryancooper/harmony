...
usage() {
  cat <<'EOF'
Usage: init-project.sh [--repo-root <path>] [--force] [--dry-run] [--no-claude-alias] [--with-boot-files]
...
DEFAULT_AGENT_EXECUTION_CONTRACT=".harmony/agency/agents/${DEFAULT_AGENT}/AGENT.md"
DEFAULT_AGENT_IDENTITY_CONTRACT=".harmony/agency/agents/${DEFAULT_AGENT}/SOUL.md"
