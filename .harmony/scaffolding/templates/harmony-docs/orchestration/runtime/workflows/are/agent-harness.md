...
1. **Central ARE prompts** (read-only methodology): `.harmony/orchestration/runtime/workflows/are/`
...
**Central prompts** (in `.harmony/orchestration/runtime/workflows/are/`):
...
```json
{
  ...
  "arePromptsPath": ".harmony/orchestration/runtime/workflows/are",
...
- Run document set analysis (use .harmony/orchestration/runtime/workflows/are/are-document-sets.md)
...
- **Central ARE prompts**: `.harmony/orchestration/runtime/workflows/are/`
...
> Central prompts are in `.harmony/orchestration/runtime/workflows/are/`.
