...
- Guided Agentic Autonomy: Allow agents to draft ADR summaries and diffs, but require ACP approval. Record pinned AI configuration and link ObservaKit traces for runs that influenced the ADR.
