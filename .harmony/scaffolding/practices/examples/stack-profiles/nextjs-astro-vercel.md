...
description: Non-normative stack-specific example for applying HSP using Next.js 16/React 19, Astro, and Vercel.
---

# Implementation Profile: Next.js/Astro/Vercel

Status: **Example profile (non-normative)**.

This file is illustrative only. Any `must`/`should` language below is
profile-local guidance for teams that choose this stack.

Related docs: [Architecture overview](/.harmony/cognition/_meta/architecture/overview.md), [Monorepo polyglot (normative)](/.harmony/cognition/_meta/architecture/monorepo-polyglot.md), [Monorepo layout](/.harmony/cognition/_meta/architecture/monorepo-layout.md), [Repository blueprint](/.harmony/cognition/_meta/architecture/repository-blueprint.md), [Runtime architecture](/.harmony/cognition/_meta/architecture/runtime-architecture.md), [Runtime policy](/.harmony/cognition/_meta/architecture/runtime-policy.md), [Observability requirements](/.harmony/cognition/_meta/architecture/observability-requirements.md), [Tooling integration](/.harmony/cognition/_meta/architecture/tooling-integration.md), [Contracts registry](/.harmony/cognition/_meta/architecture/contracts-registry.md), [Python runtime workspace example](./python-runtime-workspace.md)
...
Version note: this profile targets **Next.js 16 with React 19**. Some referenced resources (see `/.harmony/cognition/_meta/architecture/resources.md`) describe the introduction of caching and Partial Prerendering (PPR) behavior in Next.js 15; the architectural guidance here assumes those semantics as carried forward into 16+.
...
- `apps/*`:
  ...
  - Should **not** depend directly on `agents/*` or `platform/runtimes/*-runtime/**`; all interactions with Python agents or platform runtimes go through contracts (HTTP APIs and generated clients).
