...
|----------|-------------|
| [AGENTS.md](./scaffolding/runtime/templates/AGENTS.md) | Template for project-level `AGENTS.md` bootstrap |
| [BOOT.md](./scaffolding/runtime/templates/BOOT.md) | Optional recurring startup checklist template |
| [BOOTSTRAP.md](./scaffolding/runtime/templates/BOOTSTRAP.md) | Optional one-time bootstrap checklist template |
| [alignment-check](./scaffolding/runtime/templates/alignment-check) | Template for root `alignment-check` shim generated by `/init` |
