...
| [alignment-check](./scaffolding/templates/alignment-check) | Template for root `alignment-check` shim generated by `/init` |
...
| Script | Description |
|--------|-------------|
| [scaffolding/_ops/scripts/init-project.sh](./scaffolding/_ops/scripts/init-project.sh) | Project bootstrap generator for `AGENTS.md`, `CLAUDE.md` alias, `alignment-check` shim, and optional `BOOT*.md` files |
