...
- [ ] Rename docs/handbook to docs/harmony and refer to harmony as a framework/paradigm that is made up of the methodology, architecture, and toolkit.
...
- [ ] Standardize parts of the Harmony architecture into an explicit contracts using the `standardizing-convention-into-explicit-contract.md` prompt.
...
- [-] Continue kit alignment work with harmony methodology and architecture.
...
- [x] I've established the architecture and methodology foundational pieces of the harmony framework/paradigm are there any other foundational pieces that are missing?
- [x] Run platform runtime architecture update. Located in `.archive/architecture-platform-centric-runtimes`.
- [x] Ensure the Harmony Methodology has a pillar to ensure flexibility, scalability, and future-proofing of the framework.
