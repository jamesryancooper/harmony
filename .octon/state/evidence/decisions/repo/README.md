...
- Architecture contract: `/.octon/framework/cognition/_meta/architecture/state/continuity/decisions-retention.md`
- Memory governance: `/.octon/framework/agency/governance/MEMORY.md`
