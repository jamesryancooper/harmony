...
| Current concept-integration pack intent | `/.octon/inputs/exploratory/proposals/architecture/octon-concept-integration-composite-skill/**` | This follow-on packet hardens that live extension-pack landing. |
