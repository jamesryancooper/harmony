...
Automate proposal packet lifecycle actions and proposal program coordination
without changing the proposal authority model. The extension provides reusable
lifecycle routes and prompt bundles that keep packet-specific source context in
`resources/**`, operational prompts in `support/**`, and program coordination
evidence parent-owned.
