...
```markdown
┌─────────────────────────────────────────────────────────────────┐
│  .octon/capabilities/runtime/skills/          Single Location                   │
...
## Skill Contents (`.octon/capabilities/runtime/skills/`)
...
All operational categories follow the `{{category}}/{{skill-id}}/` pattern within `.octon/capabilities/runtime/skills/`:
...
| **Tier 2** | `.octon/**` | `.octon/output/exports/data.json` | Custom harness locations |
...
Operational artifacts use the categorical `{{category}}/{{skill-id}}/` pattern within `.octon/capabilities/runtime/skills/`:
...
```bash
.claude/skills/refine-prompt -> ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt
.cursor/skills/refine-prompt -> ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt
.codex/skills/refine-prompt  -> ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt
```
...
.octon/capabilities/runtime/skills/_ops/scripts/setup-harness-links.sh

# Create symlinks for a specific skill
.octon/capabilities/runtime/skills/_ops/scripts/setup-harness-links.sh refine-prompt
```
...
ln -s ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt .claude/skills/refine-prompt
ln -s ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt .cursor/skills/refine-prompt
ln -s ../../.octon/capabilities/runtime/skills/synthesis/refine-prompt .codex/skills/refine-prompt
```
...
| Permission errors | Check filesystem permissions on `.octon/capabilities/runtime/skills/` |
...
|-------|----------|------------------|
| Skills (`.octon/capabilities/runtime/skills/`) | Definitions, I/O paths, configs, outputs, logs | Host-specific invocation |
| Host Adapters (`.claude/`, `.cursor/`, etc.) | Symlinks only | Any actual content |

### Portability

Skills in `.octon/capabilities/runtime/skills/` can be:
