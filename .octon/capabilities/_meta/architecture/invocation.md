...
|----------------------|---------------------------------------------------------------------------------------|
| **Registry loading** | Loads the repo-root `.octon/capabilities/runtime/skills/registry.yml` |
...
| **Run logs**         | Written to `.octon/capabilities/runtime/skills/_ops/state/logs/{{skill-id}}/{{run-id}}.md` |
