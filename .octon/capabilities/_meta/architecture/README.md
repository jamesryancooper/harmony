...
Skills are **composable capability units** defined by the [agentskills.io](https://agentskills.io) specification. In Octon, they use a **progressive disclosure architecture**: all skill artifacts live in `.octon/capabilities/runtime/skills/`, with layered discovery from compact metadata (manifest) through full definitions (SKILL.md) to deep reference material (references/).
...
| Location | Purpose |
|----------|---------|
| `.octon/capabilities/runtime/skills/` | Skill definitions and operational state |
| `.octon/capabilities/runtime/skills/manifest.yml` | Skill index with capabilities (Tier 1 discovery) |
| `.octon/capabilities/runtime/skills/capabilities.yml` | Skill sets, valid capabilities, refs |
| `.octon/capabilities/runtime/skills/registry.yml` | Extended metadata, I/O mappings, composition (Tier 2) |
| `.octon/capabilities/runtime/skills/<skill-id>/SKILL.md` | Full skill definition (Tier 3) |
| `.octon/capabilities/runtime/skills/<skill-id>/references/` | Phase details, safety, validation (Tier 4) |
| `.octon/capabilities/runtime/skills/_scaffold/template/` | Scaffolding for new skills |
| `.octon/capabilities/runtime/skills/_ops/scripts/validate-skills.sh` | Capability validation script |
| `.octon/capabilities/runtime/skills/_ops/state/runs/{{skill-id}}/` | Execution state (checkpoints) |
| `.octon/capabilities/runtime/skills/_ops/state/logs/{{skill-id}}/` | Skill-specific logs |
...
- `.octon/capabilities/runtime/skills/refactor/refactor/` — Example skill with `[executor, guardian]` skill sets
- `.octon/capabilities/runtime/skills/synthesis/refine-prompt/` — Example skill with `[executor, collaborator]` skill sets
- `.octon/capabilities/runtime/skills/_scaffold/template/` — Skill template with capability guidance
