...
All three files live in a **single location**: `.octon/capabilities/runtime/skills/`.

---

## Shared Manifest (`.octon/capabilities/runtime/skills/manifest.yml`)
...
## Skills Registry (`.octon/capabilities/runtime/skills/registry.yml`)

Extended metadata loaded after a skill is matched—contains routing rules, commands, parameters, and requirements. Input/output paths are defined in `.octon/capabilities/runtime/skills/registry.yml` (single source of truth for I/O).
...
> **Note:** Input/output paths are defined in `.octon/capabilities/runtime/skills/registry.yml` under `skills.<id>.io`.
...
skills:
  ...
  refine-prompt:
    io:
      ...
      outputs:
        - path: ".octon/scaffolding/practices/prompts/{{timestamp}}-refined.md"
          kind: file
          format: markdown
          determinism: stable
...
> **Note:** All `.octon/capabilities/runtime/skills/` categories follow the `{{category}}/{{skill-id}}/` pattern. See [Design Conventions](../../practices/design-conventions.md#harness-skills-directory-structure) for details.
...
.octon/scaffolding/practices/prompts/{{timestamp}}-refined.md
    ...
    io:
      inputs:
        - path: "projects/{{project}}/"
          type: folder
      outputs:
        - path: "projects/{{project}}/synthesis.md"   # .octon/ideation/projects/...
          type: markdown
...
1. Read `.octon/capabilities/runtime/skills/manifest.yml` for skill index
