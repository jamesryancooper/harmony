...
executes workflow manifests natively in the Octon runtime by default, writes
...
- Execute via native adapter (`native-octon`) by default.
...
- Native adapter: `adapters/native-octon/`
