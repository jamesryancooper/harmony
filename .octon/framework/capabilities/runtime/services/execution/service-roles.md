...
- The native **Octon flow runtime** under `.octon/framework/capabilities/runtime/services/execution/flow/**`
- Optional external runtime adapters (for example LangGraph HTTP)

Use this guide together with:

- `.octon/framework/capabilities/runtime/services/planning/README.md`
- `.octon/framework/capabilities/runtime/services/planning/{spec,plan,playbook}/guide.md`
- `.octon/framework/capabilities/runtime/services/execution/{agent,flow}/guide.md`
- `.octon/framework/cognition/_meta/architecture/{overview,monorepo-layout,repository-blueprint,agent-roles}.md`
...
- In the harness runtime (`.octon/framework/capabilities/runtime/services/execution/flow/**` + runtime clients), it defines:
...
- The native runtime under `.octon/framework/capabilities/runtime/services/execution/flow/**` provides the default concrete implementation.
...
The native runtime under `.octon/framework/capabilities/runtime/services/execution/flow/**`:
...
Implement flow execution under `.octon/framework/capabilities/runtime/services/execution/flow/**` with native contracts and deterministic behavior.
...
- Wrap **BMAD** as a Octon-native service (`plan`) so that:
  ...
  - Callers rely on stable contracts under `.octon/framework/capabilities/runtime/services/planning/plan/schema/input.schema.json`.
...
- **Keep** native flow runtime in `.octon/framework/capabilities/runtime/services/execution/flow/**` as the default core runtime.
- **Add new flows** by:
