...
RETIREMENT_VALIDATOR="$OCTON_DIR/framework/assurance/runtime/_ops/scripts/validate-retirement-registry.sh"
...
main() {
  ...
  require_yq '[.tuple_admissions[] | select(.claim_effect == "admitted-live-claim")] | length == 4' "$SUPPORT_TARGETS" "live support tuple inventory is narrowed to the four admitted tuples"
