...
upgrade_supported_run_to_class_c() {
  local run_id="$1"
  local idx_file manifest_file replay_file trace_file classification_file now replay_digest trace_digest
...
main() {
  ...
  upgrade_supported_run_to_class_c "$(role_run_id external_evidence)"
