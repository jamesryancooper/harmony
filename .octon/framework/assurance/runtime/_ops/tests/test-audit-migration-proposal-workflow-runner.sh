...
new_fixture_proposal() {
  ...
  proposal_root="$fixture_root/.octon/inputs/exploratory/proposals/migration/fixture-proposal"
...
active:
  - id: "fixture-proposal"
    ...
    path: ".octon/inputs/exploratory/proposals/migration/fixture-proposal"
    title: "Fixture Migration Proposal"
    status: "draft"
    promotion_targets:
      - ".octon/example.md"
...
case_audit_passes() {
  ...
  fixture_rel=".octon/inputs/exploratory/proposals/migration/fixture-proposal"
