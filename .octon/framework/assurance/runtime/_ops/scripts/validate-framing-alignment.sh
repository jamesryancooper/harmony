...
validate_goal_explicitness_control_points() {
  ...
  require_contains_literal "$OCTON_DIR/framework/execution-roles/governance/DELEGATION.md" "$CANONICAL_GOAL" "DELEGATION.md contains canonical goal text"
  require_contains_literal "$OCTON_DIR/framework/execution-roles/governance/MEMORY.md" "$CANONICAL_GOAL" "MEMORY.md contains canonical goal text"
  require_contains_literal "$OCTON_DIR/framework/execution-roles/runtime/orchestrator/ROLE.md" "$CANONICAL_GOAL" "orchestrator AGENT.md contains canonical goal text"
