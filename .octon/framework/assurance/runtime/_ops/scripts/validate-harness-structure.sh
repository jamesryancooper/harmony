...
require_file "$OCTON_DIR/framework/constitution/contracts/assurance/review-finding-v1.schema.json"
require_file "$OCTON_DIR/framework/constitution/contracts/assurance/review-disposition-v1.schema.json"
require_file "$OCTON_DIR/framework/constitution/contracts/assurance/failure-classification-v1.schema.json"
require_file "$OCTON_DIR/framework/constitution/contracts/assurance/hardening-recommendation-v1.schema.json"
require_file "$OCTON_DIR/framework/constitution/contracts/assurance/distillation-bundle-v1.schema.json"
...
require_file "$OCTON_DIR/framework/constitution/contracts/adapters/tool-output-envelope-v1.schema.json"
...
require_file "$OCTON_DIR/instance/governance/policies/review-disposition.yml"
...
require_dir "$OCTON_DIR/state/control/execution/exceptions/leases"
...
require_dir "$OCTON_DIR/state/control/execution/missions"
require_file "$OCTON_DIR/state/control/execution/missions/mission-autonomy-live-validation/mission-classification.yml"
...
require_dir "$OCTON_DIR/state/evidence/validation/failure-distillation"
require_dir "$OCTON_DIR/state/evidence/validation/distillation"
require_dir "$OCTON_DIR/state/evidence/validation/tool-output-envelope"
require_dir "$OCTON_DIR/instance/governance/disclosure"
require_file "$OCTON_DIR/instance/governance/disclosure/README.md"
require_dir "$OCTON_DIR/state/evidence/disclosure"
require_file "$OCTON_DIR/state/evidence/disclosure/README.md"
require_dir "$OCTON_DIR/state/evidence/disclosure/runs"
require_file "$OCTON_DIR/state/evidence/disclosure/runs/README.md"
require_dir "$OCTON_DIR/state/evidence/disclosure/releases"
require_file "$OCTON_DIR/state/evidence/disclosure/releases/README.md"
