...
check_control_contracts() {
  ...
  require_literal "$GITHUB_RUNBOOK" "## Route-Neutral Main Ruleset Migration Plan" "GitHub runbook includes route-neutral migration plan" "GitHub runbook must include route-neutral migration plan"
  ...
  require_literal "$GITHUB_RUNBOOK" "Do not run until maintainer accepts the migration packet" "GitHub runbook blocks live mutation before maintainer acceptance" "GitHub runbook must block live mutation before maintainer acceptance"
