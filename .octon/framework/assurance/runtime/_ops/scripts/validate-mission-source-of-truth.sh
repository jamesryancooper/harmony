...
main() {
  ...
  if rg -n 'inputs/exploratory/proposals/.*/mission-scoped-reversible-autonomy' "$OCTON_DIR/generated/cognition/summaries" "$OCTON_DIR/generated/cognition/projections/materialized" >/dev/null 2>&1; then
