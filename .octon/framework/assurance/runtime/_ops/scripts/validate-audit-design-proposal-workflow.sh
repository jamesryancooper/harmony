...
WORKFLOW_DIR="$OCTON_DIR/orchestration/runtime/workflows/audit/audit-design-proposal"
...
CAPABILITY_MAP="$OCTON_DIR/orchestration/governance/capability-map-v1.yml"
