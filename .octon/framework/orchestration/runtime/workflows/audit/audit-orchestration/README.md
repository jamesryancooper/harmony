...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-orchestration`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-orchestration/workflow.yml`.
...
- [ ] Audit bundle exists at `.octon/state/evidence/validation/audits/YYYY-MM-DD-<slug>/`
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-orchestration/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-orchestration/stages/`
