...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-pre-release`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-pre-release/workflow.yml`.
...
- [ ] Consolidated report exists at `.octon/state/evidence/validation/analysis/YYYY-MM-DD-audit-pre-release.md`
- [ ] Pre-release bundle exists at `.octon/state/evidence/validation/audits/YYYY-MM-DD-<slug>/`
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-pre-release/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-pre-release/stages/`
