...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-post-incident`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-post-incident/workflow.yml`.
...
- `post_incident_report` -> `/.octon/state/evidence/validation/analysis/{{date}}-audit-post-incident.md`: Consolidated post-incident closure report with residual risk recommendation
- `operational_readiness_audit_report` -> `/.octon/state/evidence/validation/analysis/{{date}}-operational-readiness-audit-{{run_id}}.md`: Operational-readiness stage report (mandatory)
...
- `post_incident_audit_bundle` -> `/.octon/state/evidence/validation/audits/{{date}}-{{slug}}/`: Authoritative bounded-audit bundle for post-incident closure recommendation and done-gate evidence
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-post-incident/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-post-incident/stages/`
