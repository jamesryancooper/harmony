...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-release-readiness`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-release-readiness/workflow.yml`.
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-release-readiness/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-release-readiness/stages/`
