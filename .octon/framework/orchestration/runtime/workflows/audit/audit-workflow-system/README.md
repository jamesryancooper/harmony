...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/audit/audit-workflow-system`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/audit/audit-workflow-system/workflow.yml`.

## Parameters

- `scope` (folder, required=false), default=`.octon/framework/orchestration/runtime/workflows/`: Root workflow directory to audit.
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/audit/audit-workflow-system/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/audit/audit-workflow-system/stages/`
