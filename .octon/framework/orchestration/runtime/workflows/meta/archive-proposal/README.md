...
- `archive_proposal_workflow_summary` -> `/.octon/state/evidence/validation/analysis/{{date}}-archive-proposal.md`
- `archive_proposal_workflow_bundle` -> `/.octon/state/evidence/runs/workflows/{{date}}-archive-proposal-{{slug}}/`
