...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/meta/update-workflow`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/meta/update-workflow/workflow.yml`.
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/meta/update-workflow/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/meta/update-workflow/stages/`
