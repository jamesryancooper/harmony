...
This README summarizes the canonical workflow unit at `.octon/framework/orchestration/runtime/workflows/meta/create-workflow`.

## Prerequisites

- Required workflow inputs are available.
- Canonical workflow contract exists at `.octon/framework/orchestration/runtime/workflows/meta/create-workflow/workflow.yml`.
...
- Canonical contract: `.octon/framework/orchestration/runtime/workflows/meta/create-workflow/workflow.yml`
- Canonical stages: `.octon/framework/orchestration/runtime/workflows/meta/create-workflow/stages/`
