...
description: Run the fail-closed proposal validator stack against the scaffolded policy proposal.
---
...
1. Run:
   `bash .octon/framework/assurance/runtime/_ops/scripts/validate-proposal-standard.sh --package ".octon/inputs/exploratory/proposals/policy/<proposal_id>"`
2. Run:
   `bash .octon/framework/assurance/runtime/_ops/scripts/validate-policy-proposal.sh --package ".octon/inputs/exploratory/proposals/policy/<proposal_id>"`
3. Run:
   `bash .octon/framework/assurance/runtime/_ops/scripts/validate-proposal-implementation-readiness.sh --package ".octon/inputs/exploratory/proposals/policy/<proposal_id>"`
