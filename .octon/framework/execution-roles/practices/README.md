...
- [Change-First Default Work Unit](../../product/contracts/default-work-unit.md)
- [Commits - Convention and Discipline](commits.md)
- [Pull Requests - Convention and Quality Standards for PR-backed Changes](pull-request-standards.md)
- [Octon Git/GitHub Autonomy Workflow v1](git-github-autonomy-workflow-v1.md)
