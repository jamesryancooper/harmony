...
|--------------|-------------|
| Design decisions | `instance/cognition/decisions/` (with generated summary in `/.octon/generated/cognition/summaries/decisions.md`) |
...
```text
.octon/inputs/exploratory/ideation/scratchpad/**
...
- `.octon/inputs/exploratory/ideation/scratchpad/README.md` — Scratchpad details
- `.octon/inputs/exploratory/ideation/projects/README.md` — Projects details
