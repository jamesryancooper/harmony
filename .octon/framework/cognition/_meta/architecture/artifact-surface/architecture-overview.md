...
|-------|---------------|-----------|
| Execution Kernel | How is executable work dispatched? | `.octon/framework/engine/runtime/` |
| Service | What typed runtime operations exist? | `.octon/framework/capabilities/runtime/services/` |
| Ingress | How does human intent enter? | `.octon/framework/capabilities/runtime/commands/` |
