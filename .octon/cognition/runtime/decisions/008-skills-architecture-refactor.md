...
```
.octon/capabilities/skills/<skill-name>/
...
- `.octon/capabilities/skills/_scaffold/template/` - Updated skill template
- `.octon/orchestration/workflows/skills/create-skill/` - Updated workflow (v2.0.0)
