...
> Terminology: Slices vs Layers — see `.octon/cognition/_meta/architecture/slices-vs-layers.md`.
...
- Principle-to-kit alignment:
  `.octon/capabilities/runtime/services/_meta/docs/platform-overview.md#octon-alignment`
- Service responsibilities and boundaries:
  `.octon/capabilities/runtime/services/execution/service-roles.md`
