...
- [`.octon/framework/cognition/_meta/architecture/specification.md`](./cognition/_meta/architecture/specification.md)
...
- [`.octon/framework/cognition/governance/domain-profiles.yml`](./cognition/governance/domain-profiles.yml)
