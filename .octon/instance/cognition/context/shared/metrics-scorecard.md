...
- Digest location: `/.octon/framework/cognition/runtime/evaluations/digests/` and registered in `/.octon/framework/cognition/runtime/evaluations/digests/index.yml`.
- Action ledger location: `/.octon/framework/cognition/runtime/evaluations/actions/open-actions.yml`.
...
- Operations runbooks: `.octon/framework/cognition/practices/operations/index.yml`
- Tooling and metrics: `.octon/framework/cognition/practices/methodology/tooling-and-metrics.md`
- Reliability and ops: `.octon/framework/cognition/practices/methodology/reliability-and-ops.md`
- Risk tiers: `.octon/framework/cognition/practices/methodology/risk-tiers.md`
- Knowledge Plane: `.octon/instance/cognition/context/shared/knowledge/knowledge.md`
- Runtime evaluations surface: `.octon/framework/cognition/runtime/evaluations/README.md`
- Runtime digest surface: `.octon/framework/cognition/runtime/evaluations/digests/README.md`
- Runtime action surface: `.octon/framework/cognition/runtime/evaluations/actions/README.md`
- Observability requirements: `.octon/framework/cognition/_meta/architecture/observability-requirements.md`
